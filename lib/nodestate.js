...
(function() {
  ...
  NodeState = (function() {
    ...
    function NodeState(config) {
      var event, events, fn, from_state, state, state_name, states, to, to_states, transitions, _base, _base1, _base2, _ref, _ref1, _ref2;
      ...
      for (state_name in _ref2) {
        ...
        (_base2 = this.states[state_name])['Enter'] || (_base2['Enter'] = function(data) {
