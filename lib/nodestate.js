(function() {
  ...
  NodeState = (function() {
    ...
    function NodeState(config) {
      var event, events, fn, from_state, state, state_name, to, to_states, _base, _base2, _base3, _base4, _ref, _ref2, _ref3;
      ...
      (_base3 = this.config).sync_goto || (_base3.sync_goto = false);
      _ref3 = this.states;
      for (state_name in _ref3) {
        events = _ref3[state_name];
        (_base4 = this.states[state_name])['Enter'] || (_base4['Enter'] = function(data) {
